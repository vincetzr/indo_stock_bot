...
## 7. The horizon is not a detail — the tilt INVERTS below it

The 69.1% was quoted in a summary without "over ten years" beside it and was
immediately, and reasonably, read as a one-year number. It is not, and the
correction is larger than a rescaling.

| hold | all liquid | liquid decile | core (3 of 3) | per 10 names |
|---|---|---|---|---|
| **1 year** | 9.5% | **4.2%** | **1.0%** | **0.4 of 10** |
| 2 years | 18.9% | 11.4% | 5.4% | 1.1 of 10 |
| 3 years | 27.0% | 24.6% | 19.5% | 2.5 of 10 |
| 5 years | 39.0% | **49.3%** | 49.4% | 4.9 of 10 |
| 7.5 years | 46.7% | 62.7% | 69.5% | 6.3 of 10 |
| **10 years** | 55.5% | **70.0%** | **82.8%** | **7.0 of 10** |

**Below about three to five years this basket is the wrong side of the trade.**
At one year the most liquid names touch 2x **4.2%** of the time against
**10.2%** for the liquid names they exclude. That is not a weaker version of
the ten-year case, it is the opposite one — and A19 measured the same inversion
from the other direction, with the liquid tercile trailing the index by 9.5% a
year on one-year holds. The core cell is the extreme: **1.0% at one year,
82.8% at ten.**

`BY_HORIZON` in `scripts/decade.py` prints this on every run and four tests pin
it, so the headline figure cannot travel without its horizon again.
...
**And both numbers are TEN-YEAR figures.** At one year the same baskets deliver
0.4 and 0.1 of ten respectively. There is no version of this that is a one-year
trade — see §7.
